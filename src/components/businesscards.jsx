      ...
      <div>
        ...
        <div className="md:flex mx-20">
          <div className="border mt-10 mb-2 mr-20" style={{ width: '20rem', height: '43rem' }}>
            ...
            <p className="text-center text-sm">Order one sided business cards that simply<br />
            ...
            <div className="my-2 mx-4 text-center"><b>Material</b> - 300 gsm matte card paper stock with 600 gsm options.
            <br />
            <b>Finishing</b> - Matte Lamination with round corner options
            <br/>
              <b>Delivery</b> - 3 - 5 working days for Lagos, 5 - 7 working days for other cities
           </div>
          ...
          <div className="border mt-10 mb-2 mr-20" style={{ width: '20rem', height: '43rem' }}>
            ...
            <p className="text-center text-sm">Order premium double-sided business cards and<br />
          ...
          <div className="border mt-10 mb-2 mr-20" style={{ width: '20rem', height: '43rem' }}>
            ...
            <p className="text-center text-sm">Square it up, because everyone is going<br /> rectangular. Create unique square-shaped <br />business cards and wow everyone. Choose from<br /> our free designs, upload your own or have our<br /> design team help you fix something beautiful.
            </p>
            <div className="my-2 mx-4 text-center"><b>Material</b> - 300 gsm matte card paper stock with 600 gsm options
            <br/>
              <b>Finishing</b> - Matte Lamination with round corner options
        ...
        <div className="md:flex mx-20">
          <div className="border mt-10 mb-2 mr-20" style={{ width: '20rem', height: '45rem' }}>
           ...
           <br/>
              <b>Finishing</b> - Matte Lamination with round corner options
           <br/>
              <b>Delivery</b> - 3 - 5 working days for Lagos, 5 - 7 working days for other cities</div>
            <div className="font-bold text-center">
              Starting at <span className="line-through font-bold">₦6,999.00</span>,
           <br/>
              <span style={{ color: '#ec268f' }}>₦4,999.00</span>
          ...
          <div className="border mt-10 mb-2 mr-20" style={{ width: '20rem', height: '43rem' }}>
            ...
            <p className="text-center text-sm">Order full colour quality mini business cards that<br /> simply represent your business in special ways.<br /> Order with our free templates, upload your own<br /> designs or have a team design your business cards<br /> at a friendly fee.
            </p>
            <div className="my-2 mx-4 text-center"><b>Material</b> - 300 gsm matte card paper stock with 600 gsm options
            <br/>
              <b>Finishing</b> - Matte Lamination with round corner options
           <br/>
            ...
            <div className="font-bold text-center">
              Starting at <span className="line-through font-bold">₦5,000.00</span>,
            <br/>
              <span style={{ color: '#ec268f' }}>₦3,000.00</span></div>
            <div className="flex justify-center mt-3">
              <button className="border w-3/5 h-10 rounded mb-5" style={{ backgroundColor: '#ec268f', color: 'white' }}>
                <span>Order Now</span>
              </button>
        ...
        <div className=" mx-20  md:border  mt-10   rounded-lg mb-5 pb-5 h-auto" style={{ backgroundColor: '#dae1e7' }}>
          <div className="md:text-2xl text-center pt-5">What customers say.</div>
          <div className="md:flex">
            <div className="md:flex mr-5 ml-10 mt-10 mb-5">
              ...
              <div className="">All our business cards  <span style={{ color: '#01b0f0' }}><b>@Hotelng</b></span> are<br /> made by <span style={{ color: '#01b0f0' }}><b>@printivo</b>.</span> Really no easier<br /> way to print stuff. <span style={{ color: '#01b0f0' }}><b>@MarkEssien</b>
              </span>
              </div>
            </div>
