        ...
        <div className=" mt-3" style={{ marginLeft: '3rem', marginTop: '2rem', marginBottom: '3rem' }}>
          ...
          <div className="md:flex" style={{ marginRight: '5rem' }}>
            <div className="mt-3 mb-5">
              <button className="borderm mt-5 rounded pb-2 mb-5"
               style={{ width: '8rem', height: '2.5rem', color: '#fff', fontWeight: '500', backgroundColor: ' #ec268f' }}>Add Address<b style={{ fontSize: '1.3rem' }}>+</b> </button>
              <div className="mt-5 text-center"
               style={{ fontWeight: '400', marginRight: '12rem', width: 'auto', fontSize: '1.5rem', color: 'grey' }}>
                 <b>You have not added any Addresses.</b>
                </div>
            </div>
          </div>
        </div>
